...
$link = "getStafId&id_karyawan=" . urlencode($user);
...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <form method="post">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="jenis_kelamin2">
                <option value="0" <?php if($output1->data[0]->jenis_kelamin == "0"){echo "selected";} ?>>Laki-laki</option>
                <option value="1" <?php if($output1->data[0]->jenis_kelamin == "1"){echo "selected";} ?>>Perempuan</option>
              </select>
            </div>
            <div class="form-group">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar" style="background-color: #322F8A;">
      ...
      <a class="d-block" type="button" data-toggle="modal" data-target="#projectedit<?php echo $user; ?>">
