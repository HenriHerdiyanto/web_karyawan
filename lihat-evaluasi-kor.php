...
$link = "getEvaluasiView&id_evaluasi=" . urlencode($id_evaluasi);
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lama_percobaan" value="<?php echo $data_karyawan->data[0]->lama_percobaan; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="<?php echo $data_karyawan->data[0]->tanggal_kerja; ?>" name="tanggal_kerja">
                                </div>
                                <div class="form-group">
                                    <label>Status Karyawan</label>
                                    <select class="form-control" name="status">
                                        <option value="<?php echo $data_karyawan->data[0]->status; ?>"><?php echo $data_karyawan->data[0]->status; ?></option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="faktor_penilaian">Faktor Penilaian Karyawan</label>
                                    <textarea name="faktor_penilaian" class="form-control" cols="20" rows="5"><?php echo $data_karyawan->data[0]->faktor_penilaian; ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label>Catatan Anda Sebagai Kordinator</label>
                                    <textarea name="catatan_atasan" class="form-control" cols="20" rows="5"><?php echo $data_karyawan->data[0]->catatan_atasan; ?></textarea>
                                </div>
                                <?php
                                if ($data_karyawan->data[0]->status_evaluasi == "diproses") { ?>
                                    <div class="form-group">
                                        <label>Catatan HRD</label>
                                        <input class="form-control" type="text" value="Belum Di Lihat atau Belum Di Review Admin" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="<?= $data_karyawan->data[0]->status_evaluasi ?>" readonly>
                                    </div>
                                <?php } else { ?>
                                    <div class="form-group">
                                        <label>Catatan HRD</label>
                                        <textarea name="catatan_hrd" class="form-control" cols="20" rows="5"><?php echo $data_karyawan->data[0]->catatan_hrd; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Dievaluasi Oleh</label>
                                        <input type="text" class="form-control" name="dievaluasi_oleh" value="<?php echo $data_karyawan->data[0]->dievaluasi_oleh; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>DiSetujui Oleh</label>
                                        <input type="text" class="form-control" name="disetujui_oleh" value="<?php echo $data_karyawan->data[0]->disetujui_oleh; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Status Evaluasi</label>
                                        <input type="text" class="form-control" name="status_evaluasi" value="<?php echo $data_karyawan->data[0]->status_evaluasi; ?>">
                                    </div>
                                <?php }
                                ?>
                            </div>
