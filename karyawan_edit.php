...
$uang_transport = $data_karyawan->data[0]->uang_transport;
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="uang_makan" value="<?php echo $data_karyawan->data[0]->uang_makan; ?>">
                </div>
                <div class="form-group">
                  <label>Uang Tranasport</label>
                  <?php
                  if ($data_karyawan->data[0]->uang_transport == null) { ?>
                    <input type="text" class="form-control" name="uang_trasport" value="0">
                  <?php } else { ?>
                    <input type="text" class="form-control" name="uang_trasport" value="<?php echo $data_karyawan->data[0]->uang_transport; ?>">
                  <?php }
                  ?>
                </div>
              </div>
